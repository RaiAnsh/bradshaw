      ...
      <div className="mx-auto grid max-w-7xl items-center gap-14 px-4 sm:px-6 lg:grid-cols-2 lg:gap-20 lg:px-8">
        <div className="relative mx-auto h-[420px] w-full max-w-[560px] sm:h-[520px]">
          ...
          <a
            ...
            className="absolute bottom-[8%] left-[28%] flex h-20 w-20 items-center justify-center rounded-full bg-brand-accent text-brand-navy-dark ring-[6px] ring-neutral-950 outline outline-2 outline-offset-[-1px] outline-brand-accent transition-transform hover:scale-105 sm:h-24 sm:w-24"
          >
